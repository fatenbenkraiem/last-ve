   ...
   private toastr: NgToastService,
    ...
    createdemandeur(){
      ...
      this.contactservice.create(this.Demandeur).subscribe(data=>{
        console.log(data)
        this.toastr.success({detail:"Message succès!",summary:"Utilisateur ajouté avec succès!",duration:2000})
        this.getDemandeurs()
        this.redirectToList()
      }, error=>{
    ...
    deletedemandeur(id:number) {
      this.contactservice.deletecontact(id).subscribe(data => {
        this.toastr.success({detail:"Message succès ",summary:"Utilisateur supprimé avec succées!",duration:2000})
        this.getDemandeurs();
        this.redirectToList() 
    ...
    updatedemandeur(){
      ...
      this.contactservice.update(this.Demandeur,this.Demandeur.id).subscribe(data=>{
          ...
          this.toastr.success({detail:"Message succès",summary:"Utilisateur Modifié  avec succès!",duration:2000})
          this.getDemandeurs()
          this.redirectToList()
        }, error=>{
